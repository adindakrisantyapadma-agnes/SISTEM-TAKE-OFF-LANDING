/*
  ...
  # TelloESP32 library. It connects to the drone's WiFi network, initializes the communication protocol (SDK mode), and then disconnects. 
  # Use this as a starting point to verify your ESP32 can communicate with your Tello.
...
from djitellopy import Tello // # Import Tello from SDK 
